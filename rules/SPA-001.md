...
**Criteria:** When grouping spans by trace identifier and `service`, no more than 10 spans in a single trace SHOULD have `span.kind = SpanKind.SPAN_KIND_INTERNAL`.
